/// Represents a categorised token span returned by `topsyturvy_tc_tokens` from the Topsy Turvy toolchain.
///
...
/// `topsyturvy_tc_hover`/`topsyturvy_tc_complete`'s 0-indexed LSP convention.
