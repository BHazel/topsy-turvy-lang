...
public static class VisualNodeFactory
{
        ...
        ref int nodeCounter)
    {
        return statementType switch
        {
            ...
            "DereferenceAssignmentNode" => [SimpleStatement(statementType, "VIEW FROM IS APPOINTED", null, VisualNodeKind.Assignment, position, diagram, ref nodeCounter, dataInLabels: ["Pointer", "Value"])],
        ...
        ref int nodeCounter)
    {
        TopsyTurvyVisualNodeModel? node = statementType switch
        {
            ...
            "AddressOfExpressionNode" => ExpressionNode(statementType, "GALLERY PICTURE TO", null, VisualNodeKind.Operator, position, ref nodeCounter, dataInLabels: ["Variable"]),
            "DereferenceExpressionNode" => ExpressionNode(statementType, "VIEW FROM", null, VisualNodeKind.Operator, position, ref nodeCounter, dataInLabels: ["Pointer"]),
