...
Topsy Turvy is an esoteric but fully functional programming language to give code a flair of Gilbert & Sullivan!

Please see the [specification](./SPEC.md) for a description of the language syntax and the [examples](./examples/) directory for some sample files.

## AI Usage

AI has been extensively used in the development of Topsy Turvy, in fact, it is a case study for using AI coding agents and models!  Systems and models used are outlined below.
