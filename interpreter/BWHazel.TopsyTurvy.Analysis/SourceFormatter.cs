...
public static class SourceFormatter
{
    ...
    /// </summary>
    public static readonly string[] PostIncrease1Keywords =
    [
        "PRINCIPALS",
    ...
    /// </summary>
    public static readonly string[] PreDecrease1Keywords =
    [
        "THE CURTAIN RISES.",
    ...
    /// </summary>
    public static readonly string[] PreDecrease2Keywords =
    [
        "SO MUCH FOR THAT.",
    ...
    /// </summary>
    public static readonly string[] MidBlockKeywords =
    [
        "OR, IF NOT,",
        "OTHERWISE,",
        "WHEN ACTING AS",
    ...
    /// </summary>
    public static readonly string[] CanonicalKeywords =
    [
        "NOTHING COULD BE MORE SATISFACTORY.",
