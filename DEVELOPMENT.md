...
* **Baseline:** `dotnet build interpreter/BWHazel.TopsyTurvy.slnx --no-incremental` — 0 errors, 0 warnings. `dotnet test interpreter/BWHazel.TopsyTurvy.Tests` — 482/482. `dotnet test interpreter/BWHazel.TopsyTurvy.Cli.E2ETests` — 50/50. `dotnet test interpreter/BWHazel.TopsyTurvy.WebEditor.E2ETests` — 6/6 Playwright. `npm run test:grammar` — 4 files/all passing. `npm run test:unit` — 4/4.
