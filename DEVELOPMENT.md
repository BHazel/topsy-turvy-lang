...
* **Last Updated:** 2026-06-03 (tech review continued: Runtime and LanguageServer tests written; interpreter and handler test files split by concern; shared base classes introduced; `LanguageServerTestBase` and `TopsyTurvyInterpreterTestBase` established)
* **Specification Version:** 0.2.0 — `SPEC.md` is the grammar source of truth
* **File Extension:** `.topsy`
* **Baseline:** `dotnet build interpreter/BWHazel.TopsyTurvy.slnx --no-incremental` — 0 errors, 0 warnings. `dotnet test` — 414/414.
