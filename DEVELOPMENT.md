...
* **Last Updated:** 2026-06-07 (XML documentation completed across all AST types; `LoopDefinition` moved to Parser project; Docusaurus boilerplate removed; docs sections reduced to placeholder index pages; `SourceSpan` half-open interval documented)
